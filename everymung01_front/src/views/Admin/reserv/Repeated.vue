...
export default {
  ...
  VueGoodTable,
    ...
    return {
      ...
      rows: [
        { id:1, name:"John", age: 20, city:"busan" },
        { id:2, name:"Jane", age: 24, city:"busan" },
        { id:7, name:"Jane", age: 24,  city:"busan" },
        { id:3, name:"Susan", age: 16,  city:"busan" },
        { id:4, name:"Chris", age: 55,  city:"busan" },
        { id:5, name:"Dan", age: 40,  city:"busan" },
        { id:6, name:"John", age: 23,  city:"busan" },
      ],
    };
  },
  methods: {
